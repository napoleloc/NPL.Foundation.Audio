...
{
    public class ComponentPrefab<T>
        where T : Component
    {
        ...
        public T Instantiate(Location location)
        {
            ...
            switch (location)
            {
                case Location.PoolScene:
                {
                    ...
                    SceneManager.MoveGameObjectToScene(result.gameObject, PoolScene);
                    return result;
                }
        ...
        public T Instantiate(Location tryLocation1, Location tryLocation2, Location tryLocation3)
        {
