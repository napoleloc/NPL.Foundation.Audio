using NPL.Foundation.Audio.Collections;
using System;
...
namespace NPL.Foundation.Audio.Pooling
{
    ...
    public class ComponentPool<T>
        where T : Component
    {
        private readonly ComponentPrefab<T> _prefab;
        private readonly FasterList<T> _unusedObjects;
        ...
        public ComponentPool([NotNull] ComponentPrefab<T> prefab)
        {
            _prefab = prefab;
            _unusedObjects = new();
        ...
        public ComponentPrefab<T> Prefab
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => _prefab;
        }
        ...
        public void Prepool(int amount)
        {
            ...
            void PrepoolOne()
            {
                T go = _prefab.Instantiate(Location.Parent, Location.PoolScene, Location.Scene);
        ...
        public T Rent(bool activate = false)
        {
            if (UnusedCount < 1)
            {
                Prepool(1);
        ...
        public int RentInstanceId(bool activate = false)
        {
            ...
            Prefab.MoveToScene(obj.gameObject);
        ...
        public void RentComponents(Span<T> components, bool activate = false)
        {
            ...
            _unusedObjects.CopyTo(startIndex, components);
            _unusedInstanceIds.CopyTo(startIndex, instanceIds);
        ...
        public void ReturnComponents(ReadOnlySpan<T> objects)
        {
            var length = objects.Length;
        ...
        public void ReturnTransformIds(NativeArray<int> transformIds)
        {
            ...
            for (var i = 0; i < length; i++)
            {
                ...
                unusedInstanceIds.Add(postIds[postIdsLength++] = component.GetInstanceID());
